...
import com.themgi.todo.data.UserLoginData
import com.themgi.todo.ui.components.*

@Composable
fun LoginScreen(navHostController: NavHostController) {
    val loginFormValues by remember {
        mutableStateOf(UserLoginData())
    }
    ...
    Layout {
        Column {
            ...
            CustomOutlinedTextField(
                ...
                onChangeFieldValue = { updatedString ->
                    loginFormValues.password.value = updatedString
                },
                isSecuredField = true
            )
            ...
            PrimaryButton(
                ...
                navHostController.navigate(Screen.TestingATopAppBar.route)
            }
        ...
        Text(
            ...
            style = MaterialTheme.typography.labelSmall, modifier = Modifier
                ...
                .clickable { navHostController.navigate(Screen.RegisterAccountScreen.route) },
            fontSize = 14.sp
        )
    }
}